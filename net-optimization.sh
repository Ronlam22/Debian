...
calc_tcp_window(){
  ...
  echo
  echo "示例："
  echo "  net.ipv4.tcp_rmem = 4096 87380 ${win_bytes}"
  echo "  net.ipv4.tcp_wmem = 4096 65536 ${win_bytes}"
  echo
...
net.ipv4.tcp_mtu_probing = 0
net.ipv4.tcp_syncookies = 1
net.ipv4.tcp_rmem = 4096 87380 ${TCP_WIN_MAX}
net.ipv4.tcp_wmem = 4096 65536 ${TCP_WIN_MAX}
net.core.optmem_max = 262144
net.core.rmem_default = 131072
net.core.wmem_default = 131072
